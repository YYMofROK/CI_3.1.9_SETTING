...
class Crypto
{
	private $serverEncoding = 'UTF-8'; // 서버의 인코딩을 설정하세요
	private $innerEncoding = 'UTF-8'; // 내부적으로 처리할 인코딩을 설정하세요
	...
	private $pbUserKey	= array(49,-97,101,-52,57,97,49,97,-49,101,98,49,50,-48,55,52); // 사용자키
	...
	public function decrypt($str)
	{
		...
		$rst = iconv($this->innerEncoding, $this->serverEncoding."//IGNORE" , call_user_func_array("pack", array_merge(array("c*"), $planBytes))); // 평문블록 바이트 배열을 문자열로 변환
