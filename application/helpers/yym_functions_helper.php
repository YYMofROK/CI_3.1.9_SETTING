...
////////////////////////////////////////////////////////////////////////////////////////////////////
//
    function sendTelegraammMsg( $chat_id, $msg )
    {
        //  Telegram 메시지를 발송한다.
        //  사전에 Telegram Bot 을생성하여 관련 설정값을 취득해야함.

        $send_targetUrl	=	"https://api.telegram.org/bot348594157:AAFDssdBD6ku7koBLKggr7lV9MFfEeZshnw/sendmessage";

        $targetUrl      =   $send_targetUrl;

        //  $chat_id	    =	"427055359";        //  박세현
        //  $chat_id	    =	"384302070";        //  김진혁
        //  $chat_id	    =	"34612101";         //  육영민

        //  @   최근 100 개의 수신 내역 가져오기 - chat_id 값 설정을 위하여 필요함.
        //  https://api.telegram.org/bot348594157:AAEWS7mDA4jHHpRMQpEWDzHHxgSdnrtMsbY/getUpdates?limit=100
